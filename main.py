...
from timm.data import create_dataset, RealLabelsImagenet, Mixup
...
def get_args_parser():
    ...
    parser.add_argument('--model_ema_decay', type=float, default=[0.9999, 0.99996], nargs='+')
    ...
    parser.add_argument('--weight_decay', type=float, default=0.35,
                        help='weight decay (default: 0.05)')
    parser.add_argument('--weight_decay_end', type=float, default=None, help="""Final value of the
        weight decay. We use a cosine schedule for WD and using a larger decay by
        the end of training improves performance for ViTs.""")

    parser.add_argument('--lr', type=float, default=3.5e-3, metavar='LR',
    ...
    parser.add_argument('--log_dir', default='./weights',
